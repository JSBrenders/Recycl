...
@Entity
@Table(name = "DETAILDEPOT", schema = "RLILLE")
@IdClass(DetaildepotEntityLillePK.class)
public class DetaildepotEntityLille {
    ...
    public boolean equals(Object o) {
        ...
        DetaildepotEntityLille that = (DetaildepotEntityLille) o;
