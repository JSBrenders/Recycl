...
@Entity
@Table(name = "ENTREPRISE", schema = "RPARIS")
public class EntrepriseEntityParis {
    private Long siret;
    ...
    @Basic
    @Column(name = "RAISONSOCIALE", nullable = false, length = 50)
    ...
    public boolean equals(Object o) {
        ...
        EntrepriseEntityParis that = (EntrepriseEntityParis) o;
